...
Aum Desai
Fall 2022
CS152B Project 03 Extension

This program is for Project 03 Extension. 
It computes the thermocline.
"""
...
def density(temps):
    ...
    '''
    This function takes in a list parameter called temps. 
    It returns a list of density values.
    This function calculates the density of temp values. 
    '''
...
def thermocline_depth(temps, depths):
    ...
    '''
    This function takes two list paramters temps, depths.
    It calculates the thermocline depth and returns a float value.
    '''
...
def main():
    ...
    '''
    This function takes in no parameter. It calls upon other functions
    and appends a csv file with appropriate thermocline depth data.
    '''
    ...
    fp1 = open("Extension_Data.csv", "a")

    fp1.write("Day" + "," + "Thermocline Depth" + "\n")
    ...
    # print (or save to a file) the day of the month and thermo_depth separated by a comma
        ...
        print(day, thermo_depth)
        fp1.write(str(day) + "," + str(thermo_depth) + "\n")
