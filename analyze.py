...
This program is for Project 03. It analyzes a csv file
...
def main(filename, column_id):
    ...
    #print("sum is " + str(stats.sum(data)))
    #print("mean is " + str(stats.mean(data)))
    #print("variance is " + str(stats.variance(data)))
    #print("min is " + str(stats.min(data)))
    #print("max is " + str(stats.max(data)))
